...
<head>
    ...
    <title>Manage Class | Code360</title>
    <!-- Tailwind CSS -->
...
<body class="bg-slate-50 text-slate-800">
    ...
    <!-- Replicating Navbar for consistency since this page seems standalone -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4"><?= validation_errors(); ?></div>
        <?php endif; ?>
